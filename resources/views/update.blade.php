            ...
            <div x-show="modelOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
                ...
                <div class="flex items-end justify-center  px-4 text-center md:items-center sm:block sm:p-0">
                    ...
                    <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                        ...
                        <div>
                            <div
                                class="flex flex-col items-center min-h-screen   sm:justify-center sm:pt-0">
                                <div class="w-full px-16   overflow-hidden bg-white rounded-lg lg:max-w-4xl">
                                    <div class="mb-4">
                                        <h1 class="font-serif text-3xl font-bold underline decoration-gray-400 text-black">
                                            Modifier
                                        </h1>
                                    </div>

                                    <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                                        <form action="{{ route('update', $film['id_films']) }}" method="POST"
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    type="text" name="titre" value="{{ $film->titre }}" required />
                                            ...
                                            <!-- Description -->
                                            <div class="mt-4">
                                                <label class="block text-sm font-bold text-black" for="password">
                                                    Extait du film
                                                </label>
                                                <textarea name="extrait" class="block w-full mt-1 border-blue-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-black"
                                                    rows="4" placeholder="400" required>{{ $film->extrait }}</textarea>
                                            </div>

                                            <select name="realisateurs"
                                                class="block w-full px-4 py-2 pr-8 leading-tight bg-white border border-gray-400 rounded shadow appearance-none hover:border-gray-500 focus:outline-none focus:shadow-outline text-black">
